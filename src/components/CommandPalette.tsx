...
export const PAGES: Entry[] = [
  ...
  { id: 'page:/reading/articles', label: 'Reading · Articles', kind: 'Page', to: '/reading/articles', keywords: 'saved essays longreads' },
  { id: 'page:/links', label: 'Links', kind: 'Page', to: '/links', keywords: 'saved bookmarks interesting sites tools' },
