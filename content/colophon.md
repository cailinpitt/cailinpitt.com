...
description: "How cailinpitt.com is built: a prerendered React site, four Cloudflare Workers, and photos on R2."
---
...
Four [Cloudflare Workers](https://www.cloudflare.com/products/workers/) do the things a static site can't:
...
The first three are what [listening](/listening), [reading](/reading), [timeline](/timeline), and the [homepage](/) are built on. Each serves a cached JSON bundle the page fetches in the browser. They also render themselves as text if you aren't visiting from a browser:
