...
description: "How cailinpitt.com is built: a prerendered React site, five Cloudflare Workers, and photos on R2."
---
...
Five [Cloudflare Workers](https://www.cloudflare.com/products/workers/) do the things a static site can't:
...
The first four are what [listening](/listening), [reading](/reading), [watching](/watching), [timeline](/timeline), [guestbook](/guestbook), and the [homepage](/) are built on. Each serves a cached JSON bundle the page fetches in the browser. They also render themselves as text if you aren't visiting from a browser:
